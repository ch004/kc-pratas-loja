...
// =========================================================
// 8. FUNÇÃO DO MENU HAMBÚRGUER (TOGGLE/CLOSE)
// =========================================================
...
    // E. Inicializa o Contador do Carrinho, Carrossel e FILTROS
    renderizarCarrinho();
    showSlides(); 
    inicializarFiltros(); 
...
    // =========================================================
    // LÓGICA DO MENU HAMBÚRGUER (MOVIDA PARA DENTRO DE DOMContentLoaded)
    // =========================================================
...
    
    const imgElement = produtoDiv.querySelector('.img-principal');
    const imgPrincipalSrc = imgElement ? imgElement.src : ''; 
    
...
// =========================================================
// 9. CORREÇÃO DE ROLAGEM INVOLUNTÁRIA (SIMPLIFICADA)
// =========================================================
